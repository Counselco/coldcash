...
export const FIRST_SIX_MONTHLY_CAP_USD = 10;
export const FIRST_SIX_WINDOW_COUNT = 12;
export const FIRST_SIX_SEAT_CAP_USD = FIRST_SIX_MONTHLY_CAP_USD * FIRST_SIX_WINDOW_COUNT; // $120
export const FIRST_SIX_PROGRAM_CAP_USD = FIRST_SIX_SEAT_CAP_USD * FIRST_SIX_SEAT_COUNT; // $720
